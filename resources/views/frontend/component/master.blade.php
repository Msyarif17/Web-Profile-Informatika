...
<head>
    ...
    <link rel="icon" href="{{ asset('storage'.$cui->logo) }}" type="image/x-icon">
    <link href='https://fonts.googleapis.com/css?family={{$cui->font}}' rel='stylesheet'>
...
<body class="font-default" style="background: rgba(255, 228, 27, 0.189);
background: linear-gradient(180deg,rgba(255, 228, 27, 0.189) 0%, rgba(255,255,255,0) 50%);">
    ...
    <script src="{{asset('assets/js/popover.min.js')}}"></script>
    <script>
